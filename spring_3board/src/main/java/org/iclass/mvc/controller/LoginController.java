...
public class LoginController {
	...
	@PostMapping("/login")  //POST 요청일때 @PostMapping. param에 저장되는 것? id와 pw
	...
	@GetMapping("logout")
	public String logout(SessionStatus session) { //@SessionAttribute로 저장된 model을 관리하는 객체 
		session.setComplete(); // session 사용 완료 -> session attribute 삭제. JSESSIONID는 변경되지 않습니다. 
		return "redirect:/";
	}
